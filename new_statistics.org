...
#+RESULTS:
: PRNG bit frequency: {'0': 409649, '1': 409551}
: PRNG fraction of 1s: 0.499940185546875
: TRNG bit frequency: {'0': 409569, '1': 409631}
: TRNG fraction of 1s: 0.500037841796875
...
#+RESULTS:
:RESULTS:
: PRNG: chi2 = 0.0117, p-value = 0.9138
: TRNG: chi2 = 0.0047, p-value = 0.9454
...
#+begin_example
=== Byte Chi-squared ===
PRNG mean p-value: 0.5002, fail rate: 6.00%
TRNG mean p-value: 0.5269, fail rate: 6.50%
=== Serial Correlation (r between consecutive bytes) ===
PRNG mean r: -0.000066, std: 0.002952
TRNG mean r: -0.000159, std: 0.003007
=== Shannon Entropy (max 8.0 bits) ===
PRNG mean: 7.9982, std: 0.0002
TRNG mean: 7.9982, std: 0.0002
Saving figure byte_level_tests
#+end_example
[[file:./.ob-jupyter/4f53f035498070e3c0968c90f30ace69c899ed97.png]]
:END:
*** NIST STS
...
======================================================================
  ...
  [PASS] 01 Monobit Frequency: p = 0.495239  (0.1s)
  [PASS] 02 Block Frequency (M=128): p = 0.668165  (0.0s)
  [PASS] 03 Runs Test: p = 0.669769  (0.2s)
  [PASS] 04 Longest Run of Ones: p = 0.786113  (0.1s)
  [PASS] 05 Cumulative Sums (fwd): p = 0.879009  (0.2s)
  [PASS] 06 Cumulative Sums (bwd): p = 0.552714  (0.2s)
  [PASS] 07 Approximate Entropy (m=10): p = 0.961092  (3.5s)
  [PASS] 08 Serial Test (m=16) (1): p = 0.981401  (10.4s)
  [PASS] 08 Serial Test (m=16) (2): p = 0.967926  (10.4s)
  [PASS] 09 Maurer Universal: p = 0.188237  (0.3s)
  [PASS] 10 DFT/Spectral: p = 0.956091  (0.2s)
  [PASS] 11 Binary Matrix Rank: p = 0.298102  (2.4s)
  [PASS] 12 Non-Overlapping Template: p = 0.133880  (0.5s)
  [PASS] 13 Linear Complexity (M=500): p = 0.591668  (49.3s)

  --- Supplementary Tests ---
  [PASS] 14 Chi-Squared Byte: p = 0.652694  (0.0s)
  [INFO] 15 Compression Ratio: 1.000368  (0.0s)
  [PASS] 16 Serial Correlation: r = +0.002635
  [PASS] 17 Shannon Entropy: 7.998582 bits/byte
...
======================================================================
  ...
  --- NIST SP 800-22 Tests ---
  [PASS] 01 Monobit Frequency: p = 0.371322  (0.1s)
  [PASS] 02 Block Frequency (M=128): p = 0.304334  (0.0s)
  [PASS] 03 Runs Test: p = 0.765093  (0.2s)
  [PASS] 04 Longest Run of Ones: p = 0.887166  (0.1s)
  [PASS] 05 Cumulative Sums (fwd): p = 0.629223  (0.2s)
  [PASS] 06 Cumulative Sums (bwd): p = 0.459642  (0.3s)
  [PASS] 07 Approximate Entropy (m=10): p = 0.033828  (6.0s)
  [PASS] 08 Serial Test (m=16) (1): p = 0.394194  (13.1s)
  [PASS] 08 Serial Test (m=16) (2): p = 0.766336  (13.1s)
  [PASS] 09 Maurer Universal: p = 0.484441  (0.3s)
  [PASS] 10 DFT/Spectral: p = 0.613759  (0.3s)
  [PASS] 11 Binary Matrix Rank: p = 0.145095  (2.6s)
  [PASS] 12 Non-Overlapping Template: p = 0.198480  (0.6s)
  [PASS] 13 Linear Complexity (M=500): p = 0.321032  (55.6s)

  --- Supplementary Tests ---
  [PASS] 14 Chi-Squared Byte: p = 0.386146  (0.0s)
  [INFO] 15 Compression Ratio: 1.000368  (0.0s)
  [PASS] 16 Serial Correlation: r = +0.000774
  [PASS] 17 Shannon Entropy: 7.998489 bits/byte
...
[[file:./.ob-jupyter/4e2117fdb7f07eb9efc7d16f743f7c26163a94ba.png]]
:END:
