...
prng_bytes = randint(0, 256, BYTE_STREAM_SIZE, generator="pcg64", dtype=np.uint8).tobytes()
#+END_SRC
...
#+RESULTS:
: PRNG bit frequency: {'0': 408751, '1': 410449}
: PRNG fraction of 1s: 0.501036376953125
: TRNG bit frequency: {'0': 409644, '1': 409556}
: TRNG fraction of 1s: 0.4999462890625
...
#+RESULTS:
:RESULTS:
: PRNG: chi2 = 3.5195, p-value = 0.0606
: TRNG: chi2 = 0.0095, p-value = 0.9225
...
: PRNG mean p-value: 0.4869, std: 0.2766 0.045
: TRNG mean p-value: 0.4908, std: 0.2854 0.065
[[file:./.ob-jupyter/6ec76c6ebbb8b170cf260c7a7ac574e826a1e3ad.png]]
:END:
...
#+end_example
[[file:./.ob-jupyter/e18a643f71800926c25f501768be5fd6efedd321.png]]
:END:
** Byte-level tests
...
for _ in range(NUM_BYTE_TESTS):
    ...
    for name, stream in [("PRNG", prng_bytes), ("TRNG", trng_bytes)]:
        ...
        (prng_sc_values if name == "PRNG" else trng_sc_values).append(r)
...
print(f"PRNG mean r: {np.mean(prng_sc_values):.6f}, std: {np.std(prng_sc_values):.6f}")
...
axes[1].hist([prng_sc_values, trng_sc_values], bins=20, label=["PRNG", "TRNG"], alpha=0.7)
...
#+begin_example
=== Byte Chi-squared ===
PRNG mean p-value: 0.4563, fail rate: 5.50%
TRNG mean p-value: 0.5239, fail rate: 5.50%
=== Serial Correlation (r between consecutive bytes) ===
PRNG mean r: -0.000258, std: 0.003006
TRNG mean r: 0.000037, std: 0.003292
=== Shannon Entropy (max 8.0 bits) ===
PRNG mean: 7.9982, std: 0.0002
TRNG mean: 7.9982, std: 0.0002
Saving figure byte_level_tests
#+end_example
[[file:./.ob-jupyter/f07680f1109ddb194f016b9f1a396c540a667ff1.png]]
:END:
*** NIST STS
...
======================================================================
  ...
  [PASS] 01 Monobit Frequency: p = 0.250969  (0.1s)
  [PASS] 02 Block Frequency (M=128): p = 0.778979  (0.0s)
  [PASS] 03 Runs Test: p = 0.683774  (0.1s)
  [PASS] 04 Longest Run of Ones: p = 0.011291  (0.1s)
  [PASS] 05 Cumulative Sums (fwd): p = 0.306547  (0.1s)
  [PASS] 06 Cumulative Sums (bwd): p = 0.149172  (0.2s)
  [PASS] 07 Approximate Entropy (m=10): p = 0.031909  (4.0s)
  [PASS] 08 Serial Test (m=16) (1): p = 0.343162  (16.6s)
  [PASS] 08 Serial Test (m=16) (2): p = 0.961002  (16.6s)
  [PASS] 09 Maurer Universal: p = 0.770744  (0.4s)
  [PASS] 10 DFT/Spectral: p = 0.868803  (0.4s)
  [PASS] 11 Binary Matrix Rank: p = 0.967803  (3.2s)
  [PASS] 12 Non-Overlapping Template: p = 0.639322  (0.8s)
  [PASS] 13 Linear Complexity (M=500): p = 0.718947  (46.9s)

  --- Supplementary Tests ---
  [PASS] 14 Chi-Squared Byte: p = 0.846600  (0.0s)
  [INFO] 15 Compression Ratio: 1.000368  (0.0s)
  [PASS] 16 Serial Correlation: r = -0.001792
  [PASS] 17 Shannon Entropy: 7.998661 bits/byte
...
======================================================================
  ...
  --- NIST SP 800-22 Tests ---
  [PASS] 01 Monobit Frequency: p = 0.324133  (0.1s)
  [PASS] 02 Block Frequency (M=128): p = 0.741880  (0.0s)
  [PASS] 03 Runs Test: p = 0.262299  (0.2s)
  [PASS] 04 Longest Run of Ones: p = 0.923330  (0.1s)
  [PASS] 05 Cumulative Sums (fwd): p = 0.267215  (0.2s)
  [PASS] 06 Cumulative Sums (bwd): p = 0.315854  (0.2s)
  [PASS] 07 Approximate Entropy (m=10): p = 0.502682  (4.3s)
  [PASS] 08 Serial Test (m=16) (1): p = 0.725878  (9.1s)
  [PASS] 08 Serial Test (m=16) (2): p = 0.984493  (9.1s)
  [PASS] 09 Maurer Universal: p = 0.011661  (0.3s)
  [PASS] 10 DFT/Spectral: p = 0.056296  (0.2s)
  [PASS] 11 Binary Matrix Rank: p = 0.960108  (2.1s)
  [PASS] 12 Non-Overlapping Template: p = 0.516262  (0.6s)
  [PASS] 13 Linear Complexity (M=500): p = 0.017257  (37.0s)

  --- Supplementary Tests ---
  [PASS] 14 Chi-Squared Byte: p = 0.423961  (0.0s)
  [INFO] 15 Compression Ratio: 1.000368  (0.0s)
  [PASS] 16 Serial Correlation: r = -0.004053
  [PASS] 17 Shannon Entropy: 7.998515 bits/byte
...
for key in nist_results["PRNG"]:
    r = nist_results["PRNG"][key]
    if "p_value" in r:
...
axes[0].barh(y - 0.2, prng_pvals, 0.4, label="PRNG", alpha=0.8)
...
axes[0].set_xlim(0, 1)
axes[0].text(0.95, -1, f"PRNG: {prng_passed}/{total}  TRNG: {trng_passed}/{total}",
...
print(f"\nPRNG: {prng_passed}/{total} tests passed")
...
if prng_passed < total:
    ...
    print(f"PRNG failed: {', '.join(failed)}")
...
: 
: PRNG: 15/15 tests passed
: TRNG: 15/15 tests passed
[[file:./.ob-jupyter/f8e9bf74f8537573419b955654b2dfaf34a7027d.png]]
:END:
